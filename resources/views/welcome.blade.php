                    ...
                    <div class="row   mb-5">
                        <div class="col-12">
                            ...
                            <div class="dropdown float-right">
                                <a class="btn btn-lg btn-light dropdown-toggle products-actual-count float-end" data-bs-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">5<span class="caret"></span></a>
                    ...
                    <div class="row sorting mb-5 mt-5">
                        <div class="col-12">
                            ...
                            <div class="dropdown float-md-right">
                                <a class="btn btn-light btn-lg dropdown-toggle products-actual-count float-end" data-bs-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">5<span class="caret"></span></a>
